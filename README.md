...
Note that if the user is using spike-in normalization, either spike.fa or spike_index (from a previous spike-in normalization run) should be available in the usr directory.
